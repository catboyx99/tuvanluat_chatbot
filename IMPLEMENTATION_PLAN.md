...
- [ ] User deploy server Mode B (commit pending: `efcb377`, `8bf9728`, `5261c47`, `e82d3e8`, `5cae5b4`) → verify "chương trình 2+2" hiển thị `Thông tư Quy chế đào tạo trình độ đại học (Số 08/2021/TT-BGDĐT), ban hành ngày 08/03/2021, ...`. Re-run test_100 trên server đo target_hit production.