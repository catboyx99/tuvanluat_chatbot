...
- [ ] B4. User tự re-run `test_100_questions_4lite.py` — kỳ vọng target_hit ≥60% tổng, BHYT ≥50%, Giáo dục ≥65%
- [ ] Cập nhật Section 2.5 Giai đoạn 14 với số liệu thực tế sau test