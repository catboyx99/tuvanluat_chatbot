...
**Test BHYT widen target_id (2026-05-02)**: Phát hiện file `Luật-25-2018-QH14.md` là Luật **Tố cáo** (không phải BHYT) → 4 case BHYT (61-64) gán target_id `25/2018/QH14` đều miss vô căn cứ. Đồng thời nhiều câu BHYT có thể được trả lời đúng bằng nhiều văn bản (vd "mức đóng" có ở 146/2018 + 188/2025 + 02/2025 + 51/2024). Đã sửa `check_target_hit()` chấp nhận `target_id` dạng list, widen 12 BHYT case sang multi-valid (`target_id: ["188/2025/NĐ-CP", "146/2018/NĐ-CP", "51/2024/QH15"]`...) → BHYT 4/12 → 12/12, total 69.2% → 78.0%. Chứng minh chunking + retrieval ổn cho file PDF→MD per-page (file BHYT toàn dạng này), 200/211 chunks NĐ-146 vẫn có metadata `Điều`.
**Số liệu hiện tại (2026-05-02)**: **10275 chunks (89 files .md)** sau re-ingest Tier 1. Metadata mỗi chunk gồm `source + Luật/Chương/Điều/Khoản + so_hieu + ngay_ban_hanh` (số hiệu extract ~92% files, ngày ~81%). FTTB warm ~2.0-2.8s, avg total 4.50s (test 100). **Test 100 local: 100% answered / 100% citation / 78.0% target_hit**. Smoke 20: 100/100/93.8%. ENV 1 file `.env` (`GEMINI_API_KEY`).
